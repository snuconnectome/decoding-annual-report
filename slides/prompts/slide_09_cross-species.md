...
**Title (32pt **: "동물-사람 종간 파운데이션 · 편도체 공동연구"
**Subtitle (18pt)**: "평가항목 제4번 · 달성도 100% · 동물·사람 양측 공동연구 + 표현 학습 2 트랙"

**Top-right Hero 2단**:
- 상단 "양측 멱법칙 스케일링 경향 관찰" - 하단 "편도체 공동연구 1건 + 표현 학습 2 트랙"

**상단 공동연구 띠 (세로 약 24%)**:
- 배경 그라데이션: 좌 → 우
- 좌측 bar + 우측 bar 각
- 헤드라인: "[공동연구] 설치류 표정과 편도체 단일 뉴런 앙상블을 결합한 정서 디코딩"
...
- 하단: "동물·사람 양 트랙 공동연구 · 2023.10 – 2025.02 · 2024 iSRC 동계 성과보고회 발표"
...
- 배경, 좌측 bar
- 아이콘 상단: 뇌 + 파형 스택
- 헤드라인: "대규모 뇌영상·뇌전도 사전학습으로 범용 표상 확보함"
- (3 bullet):
...
- 하단 흰색: "4 모달리티 개별 확립 — 4차년도 통합 진입 준비. 양측 모두에서 멱법칙 스케일링 경향이 관찰되어 종간 파운데이션 가능성을 시사함"

**Bottom-left**: "증빙: 국제 발표 2건 · 투고·리뷰 중 2편 · 기술개발 (3차원 골격 추적 프로토콜) 1건"
