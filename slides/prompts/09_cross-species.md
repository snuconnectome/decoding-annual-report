...
Title: "뇌영상-파운데이션 모델 — 평가항목 3 (25%)" in 32pt Bold #003380.
...
LEFT panel — "Animal Track":
- Background: very light #FFF4DD (cream tint) or fall back to #EDF6FC
- Icon top: flat mouse silhouette in #D55E00
- Title: "동물 (Animal)" in 22pt Bold #003380
- Body bullets in 18pt #282945:
  - "대규모 행동 · 신경신호 데이터"
  - "사전학습 → 전이학습 디코딩"
  - "POYO-SSL · CausalMamba"

RIGHT panel — "Human Track":
- Background: #EDF6FC
...
Bottom-left caption: "증빙: 국제 발표 2건, 투고/리뷰 중 2편, 기술개발 1건" in 14pt #5A5A6E.

Bottom-right: "9 / 14" in 12pt #5A5A6E.

## Style Rules
- 2 side-by-side panels + 1 unified panel below
- Unified panel in SNU Blue fill (inverted) to show integration
- Short noun-phrase bullets, max 3 per panel

## Consistency Lock
Same card/panel styling as Slides 6, 8.
