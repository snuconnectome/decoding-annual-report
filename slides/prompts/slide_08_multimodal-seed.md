...
- **카드 1 — Object F1**: "핵심 객체 존재 확인을 수행함 · 정밀도·재현율 기반 · 객체 탐지 모델 활용"
...
"평가 대상 선행 디코더: MindEye2 (ICML 2024) · NeuroPictor (ECCV 2024) · UniBrain (arXiv 2024) · MindBridge (CVPR 2024) · BrainGuard (AAAI 2025)   ·   관찰된 실패 유형: 의미 근접 오차 (Semantic Near-Miss) · 의미 세부 혼동 (Semantic Detail Confusion)"
...
- 본문 흰색 11pt:
  ...
  - "UKB 42,794명 성별 분류에서 CLIP-ViT 모델이 정확도 0.94 를 보임"
