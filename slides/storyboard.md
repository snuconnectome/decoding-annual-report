...
**구체 내용**:
- 국문 제목: "동물-사람 멀티스케일 신경과학 파운데이션 모델 기반 뇌-외부환경 상호작용시의 정서에 의해 맥락화된(contextualized) 지각의 디코딩"
...
- 하단: 핵심 명제 1줄 (18pt) "정서는 뇌 기능 이해의 가장 중요한 요인"
...
## Slide 7 — 기계학습 모델 성과 (SwiFT, DIVER-0, POYO-SSL, MBBN)
...
**레이아웃**:
- 상단: "다중 모달리티 통합 · 시맨틱 평가 — 평가항목 4 (25%) · 문태섭 Lab 중심" + 우측 "100%" 배지
...
**레이아웃**:
- 상단: "뇌영상-파운데이션 모델 — 평가항목 3 (25%) 달성도 100%"
- 중앙 좌우 분할:
...
- 하단: "Thank you / Q&A" + 책임자 연락 정보 (소속·이메일 도메인만, 개인 연락처 제외)

**시각 요소**:
- 중앙 3개 카드 (SNU Ice 배경)
- 하단 "Thank you" 큰 글씨 (SNU Blue)
- Q&A 아이콘
...
| **차지욱 Lab** | #0072B2 (teal) | fMRI foundation model, depression prediction | **Slide 7** (ML 모델) | ⏳ 자료 대기 |
